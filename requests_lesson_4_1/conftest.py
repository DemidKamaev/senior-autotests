...
# Для невалидного кейса без имени
@pytest.fixture()
...
# Для проверки недопустимых значений
...
# как вызывать метод в фикструре, который как раз-таки вызывается
@patch('httpx.patch')
